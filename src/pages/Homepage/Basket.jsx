...
import { FiShoppingBag, FiMenu, FiXCircle, FiTrash, FiArrowRightCircle } from "react-icons/fi";
        ...
        <div className="basket-content">
          <div className="basket-left">
            <div className="basket-header-row">
              ...
              {/* next button (visible only on mobile) */}
              <FiArrowRightCircle
                className="next-icon"
                size={24}
          ...
          {/* Payment Section */}
          <div
            className={`basket-right ${showPayment ? "show-payment" : "hide-payment"}`}
          >
